...
\begin{document}
   ...
   \Part{Short Answer}
      ...
      \Question{Here goes some random text that should be part of the question. I will keep on writing for a while just to ensure that we have multiple lines.}
         \Subquestion[1.0]{Here goes some random text that should be part of the question. I will keep on writing for a while just to ensure that we have multiple lines.}
         \Lines{2}{1cm}
...
\Part{Short Answer}
   ...
   \Question[3.0]{Here goes some random text that should be part of the question. I will keep on writing for a while just to ensure that we have multiple lines.}
   \Lines{6}{1cm}

   \Question[2.0]{Here goes some random text that should be part of the question. I will keep on writing for a while just to ensure that we have multiple lines.}
   \Lines{6}{1cm}

   \Question[2.5]{Here goes some random text that should be part of the question. I will keep on writing for a while just to ensure that we have multiple lines.}
   \Lines{6}{1cm}

   \Question[1.5]{Here goes some random text that should be part of the question. I will keep on writing for a while just to ensure that we have multiple lines.}
...
%The optional argument was \test[shubidu, kauai]
